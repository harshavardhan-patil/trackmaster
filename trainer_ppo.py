...
class FullyLocalTrainer:
    ...
    def collect_episode(self) -> Dict[str, Any]:
        ...
        # Determine if episode was truncated (hit time limit) or naturally terminated
        # For proper GAE bootstrapping:
        # - If truncated: bootstrap from final state value (agent was still "alive")
        # - If terminated: use 0 as terminal value (episode naturally ended)
        is_truncated = (truncated or step_count >= self.max_episode_steps) and not terminated
